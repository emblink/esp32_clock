...
static WifiConnectionCallback connectionCb = NULL;
...
{
    connectionCb = onConnectionCb;
    xTaskCreate(wifiStationTask, "Wi-Fi Station Task", 4096, NULL, 5, NULL);
}
